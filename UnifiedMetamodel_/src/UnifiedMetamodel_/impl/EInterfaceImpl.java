 ...
 * </p>
 * <ul>
 *   <li>{@link UnifiedMetamodel_.impl.EInterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link UnifiedMetamodel_.impl.EInterfaceImpl#getAbstractmethod <em>Abstractmethod</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EInterfaceImpl extends MinimalEObjectImpl.Container implements EInterface {
	...
	protected EClass eStaticClass() {
		return UnifiedMetamodel_Package.Literals.EINTERFACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedMetamodel_Package.EINTERFACE__NAME, oldName, name));
	}
	...
	public EList<AbstractMethod> getAbstractmethod() {
		if (abstractmethod == null) {
			abstractmethod = new EObjectContainmentEList<AbstractMethod>(AbstractMethod.class, this, UnifiedMetamodel_Package.EINTERFACE__ABSTRACTMETHOD);
		}
