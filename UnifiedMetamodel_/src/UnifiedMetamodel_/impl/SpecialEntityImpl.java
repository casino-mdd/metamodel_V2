 ...
 *   <li>{@link UnifiedMetamodel_.impl.SpecialEntityImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecialEntityImpl extends EntityImpl implements SpecialEntity {
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedMetamodel_Package.SPECIAL_ENTITY__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UnifiedMetamodel_Package.SPECIAL_ENTITY__TYPE:
				return getType();
		}
