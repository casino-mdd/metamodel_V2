 ...
 * </p>
 * <ul>
 *   <li>{@link UnifiedMetamodel_.impl.JavaAppImpl#getJee_project <em>Jee project</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaAppImpl extends MinimalEObjectImpl.Container implements JavaApp {
	...
	protected EClass eStaticClass() {
		return UnifiedMetamodel_Package.Literals.JAVA_APP;
	}
	...
	public EList<JEE_Project> getJee_project() {
		if (jee_project == null) {
			jee_project = new EObjectContainmentEList<JEE_Project>(JEE_Project.class, this, UnifiedMetamodel_Package.JAVA_APP__JEE_PROJECT);
		}
		return jee_project;
	}
