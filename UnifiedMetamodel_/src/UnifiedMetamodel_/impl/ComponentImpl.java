...
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	protected EClass eStaticClass() {
		return UnifiedMetamodel_Package.Literals.COMPONENT;
	}
	...
	public EList<Layer> getLayers() {
		if (layers == null) {
			layers = new EObjectContainmentEList<Layer>(Layer.class, this, UnifiedMetamodel_Package.COMPONENT__LAYERS);
		}
		return layers;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedMetamodel_Package.COMPONENT__NAME, oldName, name));
	}
