...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Anotationi</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link UnifiedMetamodel_.impl.AnotationiImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link UnifiedMetamodel_.impl.AnotationiImpl#getDescriptor <em>Descriptor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnotationiImpl extends EClassImpl implements Anotationi {
	/**
	...
	protected EClass eStaticClass() {
		return UnifiedMetamodel_Package.Literals.ANOTATIONI;
	}
	...
	public void setProperties(String newProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedMetamodel_Package.ANOTATIONI__PROPERTIES, oldProperties, properties));
	}
	...
	public Descriptor getDescriptor() {
		if (descriptor != null && descriptor.eIsProxy()) {
			...
			if (descriptor != oldDescriptor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnifiedMetamodel_Package.ANOTATIONI__DESCRIPTOR, oldDescriptor, descriptor));
			}
		}
		return descriptor;
	}
	...
	public void setDescriptor(Descriptor newDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedMetamodel_Package.ANOTATIONI__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnifiedMetamodel_Package.ANOTATIONI__PROPERTIES:
				return getProperties();
			case UnifiedMetamodel_Package.ANOTATIONI__DESCRIPTOR:
