...
/**
 * This is the item provider adapter for a {@link UnifiedMetamodel_.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UnifiedMetamodel_Package.Literals.LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIsNativePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Library_isNative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Library_isNative_feature", "_UI_Library_type"),
				 UnifiedMetamodel_Package.Literals.LIBRARY__IS_NATIVE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.LIBRARY__NATIVECLASS);
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.LIBRARY__ANNOTATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.LIBRARY__NATIVECLASS,
				 UnifiedMetamodel_Factory.eINSTANCE.createNativeClass()));

		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.LIBRARY__ANNOTATION,
