...
/**
 * This is the item provider adapter for a {@link UnifiedMetamodel_.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UnifiedMetamodel_Package.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAnnotationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_annotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_annotation_feature", "_UI_Attribute_type"),
				 UnifiedMetamodel_Package.Literals.ATTRIBUTE__ANNOTATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UnifiedMetamodel_Package.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 true,
				 null,
