...
/**
 * This is the item provider adapter for a {@link UnifiedMetamodel_.Metamodel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetamodelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UnifiedMetamodel_Package.Literals.METAMODEL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.METAMODEL__ARQUITECTUREMETAMODEL);
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.METAMODEL__DOMAINMETAMODEL);
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.METAMODEL__TECHNOLOGYMETAMODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.METAMODEL__ARQUITECTUREMETAMODEL,
				 UnifiedMetamodel_Factory.eINSTANCE.createArquitectureMetamodel()));

		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.METAMODEL__DOMAINMETAMODEL,
				 UnifiedMetamodel_Factory.eINSTANCE.createDomainMetamodel()));

		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.METAMODEL__TECHNOLOGYMETAMODEL,
				 UnifiedMetamodel_Factory.eINSTANCE.createTechnologyMetamodel()));
	}
