...
/**
 * This is the item provider adapter for a {@link UnifiedMetamodel_.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider extends EClassItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_properties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_properties_feature", "_UI_Annotation_type"),
				 UnifiedMetamodel_Package.Literals.ANNOTATION__PROPERTIES,
				 true,
				 false,
				 false,
	...
	protected void addDescriptorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_descriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_descriptor_feature", "_UI_Annotation_type"),
				 UnifiedMetamodel_Package.Literals.ANNOTATION__DESCRIPTOR,
				 true,
				 false,
				 true,
				 null,
