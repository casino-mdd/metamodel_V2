...
/**
 * This is the item provider adapter for a {@link UnifiedMetamodel_.EClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EClassItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UnifiedMetamodel_Package.Literals.ECLASS__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAnnotationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EClass_annotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EClass_annotation_feature", "_UI_EClass_type"),
				 UnifiedMetamodel_Package.Literals.ECLASS__ANNOTATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.ECLASS__ATTRIBUTE);
			childrenFeatures.add(UnifiedMetamodel_Package.Literals.ECLASS__METHOD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.ECLASS__ATTRIBUTE,
				 UnifiedMetamodel_Factory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(UnifiedMetamodel_Package.Literals.ECLASS__METHOD,
				 UnifiedMetamodel_Factory.eINSTANCE.createMethodBack()));
	}
